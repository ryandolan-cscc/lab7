...
public class RPSLSpock {
    ...
    /**
     * @author Ryan Dolan
     * @param pick String to compare against the picked item
     * @return Boolean of whether the pick was valid or not
     * */
    ...
    /**
     * @author Ryan Dolan
     * @return String of the random pick
     * */
    ...
    /**
     * @author Ryan Dolan
     * @param c_pick computer pick, h_pick human pick
     * @return Boolean of whether the pick was correct or not
     * */
